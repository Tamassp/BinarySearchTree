...
public class BinaryTreeTest
{
  ...
  void contains() {
    ...
    tree.getRoot().getRightChild().addRightChild(node);
  ...
  void inOrder() {
    ...
    Object[] integers = new Object[]{8, 5, 2, 3, 1, 7};
  ...
  void preOrder() {
    print.printTree(tree.getRoot());
    Object[] integers = new Object[]{3,5,8,2,7,1};
  ...
  void postOrder() {
    print.printTree(tree.getRoot());
    Object[] integers = new Object[]{8, 2, 5, 1, 7, 3};
  ...
  void levelOrder() {
    print.printTree(tree.getRoot());
    Object[] integers = new Object[]{3,5,7,8,2,1};
